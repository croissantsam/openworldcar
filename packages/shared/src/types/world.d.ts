...
export type HighwayType = 'motorway' | 'trunk' | 'primary' | 'secondary' | 'tertiary' | 'residential' | 'service' | 'path' | 'footway' | 'cycleway' | 'unclassified';
export type Road = {
    id: string;
    highway: HighwayType;
    name?: string;
...
export type PoiCategory = 'fuel' | 'parking' | 'restaurant' | 'hospital' | 'police' | 'shop' | 'other';
