import { geoToWorld, setWorldOrigin, } from '@world-drive/math';
 ...
 */
export function geoBoundingBox(centre, radiusMetres) {
...
export function lonLatArrayToWorld(coords) {
    return coords.map(([lon, lat]) => geoToWorld({ latitude: lat, longitude: lon }));
}
